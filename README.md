...
[Contributor License Agreement](CLA.md) — include the sign-off line in your
PR description.

## License

Source code is licensed under [AGPL-3.0](LICENSE).
Copyright © 2026 Lumination Labs, Inc.

The **"Maple View"** name, **"Maple View NVR Viewer"** long-form name, and
the Maple View app icon/logo are trademarks of Lumination Labs, Inc. and are
**not** covered by the AGPL-3.0 code license — see
[TRADEMARK.md](TRADEMARK.md). Forks must rebrand.
